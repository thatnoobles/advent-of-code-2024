...
with open("input.txt", "r") as file:
    ...
    for i in range(0, len(lines), 4):
        ...
        prize = (int(lines[i + 2].split(": ")[1].split(", ")[0][2:]) + 10000000000000, int(lines[i + 2].split(": ")[1].split(", ")[1][2:]) + 10000000000000)
